  ...
  >
    <div class="form-basic-container">
      <div class="form-basic-item">
        <div class="form-basic-container-title">入库信息</div>
        <!-- 表单内容 -->

        <!-- 合同名称,合同类型 -->
        <t-row class="row-gap" :gutter="[32, 24]">
          <t-col :span="6">
            <t-form-item label="入库编号" name="id">
              <t-input v-model="formData.id" :style="{ width: '322px' }" placeholder="请输入内容" readonly />
            </t-form-item>
            <!-- //dgsdgs -->
          </t-col>
          <t-col :span="6">
            <t-form-item label="产品编号" name="id">
          ...
          <t-col :span="6">
            <t-form-item label="业务编号" name="category">
              <t-select
          ...
          <t-col :span="6">
            <t-form-item label="入库时间" name="in_time">
              <t-date-picker
...
import { getInDetail, InPutModify } from '@/api/list';
...
const fetchData = async () => {
  ...
  try {
    const list = await getInDetail(id);
