...
export const FORM_RULES: Record<string, FormRule[]> = {
  ...
  cid: [{ required: true, message: '请输入顾客编号', type: 'error' }],
  pid: [{ required: true, message: '请选择产品类型', type: 'error' }],
  sid: [{ required: true, message: '请选择供应商', type: 'error' }],
  book_time: [{ required: true, message: '请选择日期', type: 'error' }],
  order_time: [{ required: true, message: '请选择日期', type: 'error' }],
  ...
  method: [{ required: true, message: '请选择付款方式', type: 'error' }],
  pay_time: [{ required: true, message: '请选择日期', type: 'error' }],
  address: [{ required: true, message: '请输入发货地址', type: 'error' }],
  person: [{ required: true, message: '请输入发货人', type: 'error' }],
  state: [{ required: true, message: '请选择状态', type: 'error' }],
};
